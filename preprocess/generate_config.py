...
ex_models = ['vit_base_patch16_224.augreg2_in21k_ft_in1k','beit_base_patch16_384.in22k_ft_in22k_in1k', 'resnet50.a1_in1k', 'vgg19.tv_in1k','densenet121.ra_in1k', 'mobilenetv3_small_050.lamb_in1k',]
ex_datasets = ['CIFAR10', 'CIFAR100','GTSRB', 'tiny-imagenet', 'FashionMNIST']
vit_like = [ 'vit_base_patch16_224.augreg2_in21k_ft_in1k','beit_base_patch16_384.in22k_ft_in22k_in1k',]
                ...
                for index in range(2):
                    ...
                    if clean :
                        if dataset in torch_datasets:
                            ...
                            cfg['dataset'] = 'torch/' + dataset
                        else:
                            cfg['data_dir'] = pargs[0] + dataset + '_poison' + '_0'
                            cfg['val_split'] = 'clean'
                        cfg_name = '_'.join([dataset, model]) + '.yaml'
                        ...
                        for rate in rates:
                            ...
                            for j in range(2):
                                ...
                                cfg_name = '_'.join([dataset, model, str(int(rate * 100))]) + '.yaml'
